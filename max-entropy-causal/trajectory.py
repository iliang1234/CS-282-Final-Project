...
def generate_trajectory(world, policy, start, final, seed):
    """
...
def generate_trajectories(n, world, policy, start, final):
    ...
    def _generate_one(seed):
        ...
        return generate_trajectory(world, policy, s, final, seed = seed)

    return (_generate_one(seed = _) for _ in range(n))
